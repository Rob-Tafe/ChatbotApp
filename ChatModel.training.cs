    ...
    public partial class ChatModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Question",outputColumnName:@"Question")      
                                    ...
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Answer",inputColumnName:@"Answer",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.03125F,LabelColumnName=@"Answer",FeatureColumnName=@"Features"}), labelColumnName:@"Answer"))      
