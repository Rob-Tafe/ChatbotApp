...
namespace ChatbotApp
{
    public partial class ChatModel
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath("ChatModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Answer");
            if (labelColumn == null)
            {
                throw new Exception("Answer column not found. Make sure the name searched for matches the name in the schema.");
            }
